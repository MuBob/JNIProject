...
/*
 *   Karatsuba method for multiprecision multiplication combined with 
...
{ /* multiply two arrays of length MR_KCM */ 
    ...
    mr_vlarge sum;
 #else
    register mr_small extra,s0 = 0,s1 = 0;
...
/*** MULTIPLY ***/
  ...
  pp2=(mr_large)a[1]*b[2];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[2]*b[1];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[3]*b[0];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
  ...
  pp2=(mr_large)a[1]*b[3];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[2]*b[2];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[3]*b[1];
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  pp2=(mr_large)a[1]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[2]*b[3];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[3]*b[2];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[4]*b[1];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[5]*b[0];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[0]*b[6];
  pp2=(mr_large)a[1]*b[5];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[2]*b[4];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[3]*b[3];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[4]*b[2];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[5]*b[1];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[6]*b[0];
  sum+=pp2;
  extra+=(sum<pp2);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[0]*b[7];
  pp2=(mr_large)a[1]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[2]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[3]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[4]*b[3];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[5]*b[2];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[6]*b[1];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[7]*b[0];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[1]*b[7];
  pp2=(mr_large)a[2]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[3]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[4]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[5]*b[3];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[6]*b[2];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[7]*b[1];
  sum+=pp2;
  extra+=(sum<pp2);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[2]*b[7];
  pp2=(mr_large)a[3]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[4]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[5]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[6]*b[3];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[7]*b[2];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[3]*b[7];
  pp2=(mr_large)a[4]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[5]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[6]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[7]*b[3];
  sum+=pp2;
  extra+=(sum<pp2);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[4]*b[7];
  pp2=(mr_large)a[5]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[6]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  pp2=(mr_large)a[7]*b[4];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[5]*b[7];
  pp2=(mr_large)a[6]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  pp1=(mr_large)a[7]*b[5];
  sum+=pp2;
  extra+=(sum<pp2);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[6]*b[7];
  pp2=(mr_large)a[7]*b[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp2;
  extra+=(sum<pp2);
...
/*** SQUARE ***/
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[0]*a[6];
  pp2=(mr_large)a[1]*a[5];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[0]*a[7];
  pp2=(mr_large)a[1]*a[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[1]*a[7];
  pp2=(mr_large)a[2]*a[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[2]*a[7];
  pp2=(mr_large)a[3]*a[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[3]*a[7];
  pp2=(mr_large)a[4]*a[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
  ...
  sum=(sum>>MIRACL)|((mr_large)extra<<MIRACL);
  extra=0;
  pp1=(mr_large)a[4]*a[7];
  pp2=(mr_large)a[5]*a[6];
  sum+=pp1;
  extra+=(sum<pp1);
  sum+=pp1;
  extra+=(sum<pp1);
