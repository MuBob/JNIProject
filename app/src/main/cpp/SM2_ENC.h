...
5.Test_Point
//test whether thecalculation is correctbycomparing
...
//key deviding function base on SM3, generates key
12.SM3_KDF
stream
Notes:
...
notprovide MIRACLlibrary,MIRACLlicenseor anypermission to use MIRACL library.Any commercial
