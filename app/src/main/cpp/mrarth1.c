...
/* multiplying and dividing BIG NUMBERS by  integer numbers. */
...
{ 
    int m,xl;
    mr_lentype sx;
    mr_small carry,*xg=NULL,*zg = NULL;
...
{ /* convert positive big into octet string */
    int i,j = 0,r = 0,m = 0,n = 0,len,start = 0;
    unsigned int dig;
    unsigned char ch;
    mr_small wrd = 0;
